...
function IconHome(props: IconHomeProps): JSX.Element {
  const { className } = props;

  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 578 584">
...
export default memo(IconHome, IsEqual);
